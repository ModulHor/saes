...
public class CargoEmpleado extends Pantalla {
    private Tabla tab_cargo =  new Tabla();
    
    public CargoEmpleado(){
         tab_cargo.setId("tab_cargo");   //identificador
         tab_cargo.setTabla("SAES_CARGO", "IDE_SACARG", 1);
         tab_cargo.getColumna("IDE_SACARG").setNombreVisual("CODIGO");
         tab_cargo.getColumna("DESCRIPCION_SACARG").setNombreVisual("DESCRIPCION CARGO");
         tab_cargo.getColumna("ACTIVO_SACARG").setNombreVisual("ACTIVO");
         tab_cargo.dibujar();
